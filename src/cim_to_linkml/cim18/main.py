...
from cim_to_linkml.cim18.generator import generate_schema
from cim_to_linkml.cim18.uml.parser import parse_uml_project
from cim_to_linkml.cim18.uml.reader import read_uml_packages, read_uml_classes, read_uml_relations
...
def _generate_linkml_schema(cim_db, output_dir):
    ...
    # linkml_schema = generate_schema(uml_project, 3)
